...
def create_regions_and_locations(world: "SohWorld") -> None:
    ...
    for region in dungeoon_regions:
        region_file = region[0]
        region_type = region[1]
        dungeon_quest = world.dungeon_quests[region_type]

        region.init_regions(world, dungeon_quest)
    ...
    for region in dungeoon_regions:
        ...
        region_file.set_region_rule(world, dungeon_quest)

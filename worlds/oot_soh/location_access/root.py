...
def set_region_rules(world: "SohWorld") -> None:
    ...
    if (world.options.starting_age == "adult" and not world.options.shuffle_master_sword):
        # Connections
        connect_regions(Regions.ROOT, world, [
            (Regions.MASTER_SWORD_PEDESTAL, True_())
        ])
    ...
    connect_regions(Regions.ROOT_EXITS, world, [
        ...
        (Regions.MINUET_OF_FOREST_WARP, True_()),
        (Regions.BOLERO_OF_FIRE_WARP, True_()),
        (Regions.SERENADE_OF_WATER_WARP, True_()),
        (Regions.NOCTURNE_OF_SHADOW_WARP, True_()),
        (Regions.REQUIEM_OF_SPIRIT_WARP, True_()),
        (Regions.PRELUDE_OF_LIGHT_WARP, True_()),
    ])

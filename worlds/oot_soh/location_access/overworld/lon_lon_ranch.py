...
def set_region_rules(world: "SohWorld") -> None:
    ...
    add_locations(Regions.LLR_GROTTO, world, [
        (Locations.LLR_DEKU_SCRUB_GROTTO_LEFT,
         lambda bundle: can_stun_deku(bundle) & can_afford_slot(Locations.LLR_DEKU_SCRUB_GROTTO_LEFT, bundle)),
        (Locations.LLR_DEKU_SCRUB_GROTTO_RIGHT,
         lambda bundle: can_stun_deku(bundle) & can_afford_slot(Locations.LLR_DEKU_SCRUB_GROTTO_RIGHT, bundle)),
        (Locations.LLR_DEKU_SCRUB_GROTTO_CENTER,
         lambda bundle: can_stun_deku(bundle) & can_afford_slot(Locations.LLR_DEKU_SCRUB_GROTTO_CENTER, bundle)),

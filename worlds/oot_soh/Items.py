...
item_data_table: dict[Items, SohItemData] = {
    ...
    Items.GREAT_DEKU_TREE_MAP: SohItemData(78, IC.useful | IC.deprioritized, 0, item_groups=["Maps", "Map"]),
    Items.DODONGOS_CAVERN_MAP: SohItemData(79, IC.useful | IC.deprioritized, 0, item_groups=["Maps", "Map"]),
    Items.JABU_JABUS_BELLY_MAP: SohItemData(80, IC.useful | IC.deprioritized, 0, item_groups=["Maps", "Map"]),
    Items.FOREST_TEMPLE_MAP: SohItemData(81, IC.useful | IC.deprioritized, 0, item_groups=["Maps", "Map"]),
    Items.FIRE_TEMPLE_MAP: SohItemData(82, IC.useful | IC.deprioritized, 0, item_groups=["Maps", "Map"]),
    Items.WATER_TEMPLE_MAP: SohItemData(83, IC.useful | IC.deprioritized, 0, item_groups=["Maps", "Map"]),
    Items.SPIRIT_TEMPLE_MAP: SohItemData(84, IC.useful | IC.deprioritized, 0, item_groups=["Maps", "Map"]),
    Items.SHADOW_TEMPLE_MAP: SohItemData(85, IC.useful | IC.deprioritized, 0, item_groups=["Maps", "Map"]),
    Items.BOTTOM_OF_THE_WELL_MAP: SohItemData(86, IC.useful | IC.deprioritized, 0, item_groups=["Maps", "Map"]),
    Items.ICE_CAVERN_MAP: SohItemData(87, IC.useful | IC.deprioritized, 0, item_groups=["Maps", "Map"]),
    Items.GREAT_DEKU_TREE_COMPASS: SohItemData(88, IC.useful | IC.deprioritized, 0, item_groups=["Compasses", "Compass"]),
    Items.DODONGOS_CAVERN_COMPASS: SohItemData(89, IC.useful | IC.deprioritized, 0, item_groups=["Compasses", "Compass"]),
    Items.JABU_JABUS_BELLY_COMPASS: SohItemData(90, IC.useful | IC.deprioritized, 0, item_groups=["Compasses", "Compass"]),
    Items.FOREST_TEMPLE_COMPASS: SohItemData(91, IC.useful | IC.deprioritized, 0, item_groups=["Compasses", "Compass"]),
    Items.FIRE_TEMPLE_COMPASS: SohItemData(92, IC.useful | IC.deprioritized, 0, item_groups=["Compasses", "Compass"]),
    Items.WATER_TEMPLE_COMPASS: SohItemData(93, IC.useful | IC.deprioritized, 0, item_groups=["Compasses", "Compass"]),
    Items.SPIRIT_TEMPLE_COMPASS: SohItemData(94, IC.useful | IC.deprioritized, 0, item_groups=["Compasses", "Compass"]),
    Items.SHADOW_TEMPLE_COMPASS: SohItemData(95, IC.useful | IC.deprioritized, 0, item_groups=["Compasses", "Compass"]),
    Items.BOTTOM_OF_THE_WELL_COMPASS: SohItemData(96, IC.useful | IC.deprioritized, 0, item_groups=["Compasses", "Compass"]),
    Items.ICE_CAVERN_COMPASS: SohItemData(97, IC.useful | IC.deprioritized, 0, item_groups=["Compasses", "Compass"]),
    ...
    Items.PIECE_OF_HEART: SohItemData(140, IC.useful | IC.skip_balancing | IC.deprioritized, 35, item_groups=["Hearts", "Heart"]),
    ...
    Items.PIECE_OF_HEART_WINNER: SohItemData(161, IC.skip_balancing | IC.deprioritized, 1),

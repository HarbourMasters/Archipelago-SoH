...
item_data_table: dict[Items, SohItemData] = {
    ...
    Items.LENS_OF_TRUTH: SohItemData(13, IC.progression | IC.useful, 1, item_type=ItemType.magic),
    Items.MEGATON_HAMMER: SohItemData(14, IC.progression | IC.useful, 1, adult_only=True),
    ...
    Items.PROGRESSIVE_HOOKSHOT: SohItemData(39, IC.progression | IC.useful, 2, item_groups=GroupTag.Hookshot_Upgrade),
    Items.STRENGTH_UPGRADE: SohItemData(40, IC.progression | IC.useful, 3, item_groups=GroupTag.Strength_Upgrade),
    ...
    Items.PROGRESSIVE_SCALE: SohItemData(45, IC.progression | IC.useful, 2, item_groups=GroupTag.Scale),
    ...
    Items.FOREST_TEMPLE_SMALL_KEY: SohItemData(104, IC.progression, 5, item_groups=GroupTag.Small_Key),
    Items.FIRE_TEMPLE_SMALL_KEY: SohItemData(105, IC.progression, 8, item_groups=GroupTag.Small_Key),
    Items.WATER_TEMPLE_SMALL_KEY: SohItemData(106, IC.progression, 6, item_groups=GroupTag.Small_Key),
    Items.SPIRIT_TEMPLE_SMALL_KEY: SohItemData(107, IC.progression, 5, item_groups=GroupTag.Small_Key),
    Items.SHADOW_TEMPLE_SMALL_KEY: SohItemData(108, IC.progression, 5, item_groups=GroupTag.Small_Key),
    Items.BOTTOM_OF_THE_WELL_SMALL_KEY: SohItemData(109, IC.progression, 3, item_groups=GroupTag.Small_Key),
    Items.TRAINING_GROUND_SMALL_KEY: SohItemData(110, IC.progression, 9, item_groups=GroupTag.Small_Key),
    Items.GERUDO_FORTRESS_SMALL_KEY: SohItemData(111, IC.progression, 4, item_groups=GroupTag.Small_Key),
    Items.GANONS_CASTLE_SMALL_KEY: SohItemData(112, IC.progression, 2, item_groups=GroupTag.Small_Key),
    Items.TREASURE_GAME_SMALL_KEY: SohItemData(113, IC.progression, 0, item_groups=GroupTag.Small_Key),
    Items.FOREST_TEMPLE_KEY_RING: SohItemData(114, IC.progression, 0, item_groups=GroupTag.Small_Key),
    Items.FIRE_TEMPLE_KEY_RING: SohItemData(115, IC.progression, 0, item_groups=GroupTag.Small_Key),
    Items.WATER_TEMPLE_KEY_RING: SohItemData(116, IC.progression, 0, item_groups=GroupTag.Small_Key),
    Items.SPIRIT_TEMPLE_KEY_RING: SohItemData(117, IC.progression, 0, item_groups=GroupTag.Small_Key),
    Items.SHADOW_TEMPLE_KEY_RING: SohItemData(118, IC.progression, 0, item_groups=GroupTag.Small_Key),
    Items.BOTTOM_OF_THE_WELL_KEY_RING: SohItemData(119, IC.progression, 0, item_groups=GroupTag.Small_Key),
    Items.TRAINING_GROUND_KEY_RING: SohItemData(120, IC.progression, 0, item_groups=GroupTag.Small_Key),
    Items.GERUDO_FORTRESS_KEY_RING: SohItemData(121, IC.progression, 0, item_groups=GroupTag.Small_Key),
    Items.GANONS_CASTLE_KEY_RING: SohItemData(122, IC.progression, 0, item_groups=GroupTag.Small_Key),
    Items.TREASURE_GAME_KEY_RING: SohItemData(123, IC.progression, 0, item_groups=GroupTag.Small_Key),
